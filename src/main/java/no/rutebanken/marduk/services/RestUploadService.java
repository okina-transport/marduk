...
public class RestUploadService {
    ...
    public HttpStatusCode uploadStream(InputStream stream, String restUrl, String filename, String key, String secret) throws IOException {
        ...
        try(ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            baos.flush();
            try (InputStream inputStreamToSend = new ByteArrayInputStream(baos.toByteArray())) {
