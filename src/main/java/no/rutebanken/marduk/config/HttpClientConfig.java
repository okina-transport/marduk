...
public class HttpClientConfig {
    ...
    public HttpClientConfigurer httpClientConfigurer(@Autowired CamelContext camelContext) {
        ...
        HttpClientConfigurer httpClientConfigurer = httpClientBuilder -> httpClientBuilder.setDefaultHeaders(Arrays.asList(new BasicHeader(ET_CLIENT_ID_HEADER, clientId), new BasicHeader(ET_CLIENT_NAME_HEADER, clientName)));
