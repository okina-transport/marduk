...
public class JobEvent {
    ...
    public enum TimetableAction {FILE_TRANSFER, FILE_CLASSIFICATION, FILE_ANALYZE, IMPORT, IMPORT_NETEX, EXPORT, VALIDATION_LEVEL_1, VALIDATION_LEVEL_2, CLEAN, DATASPACE_TRANSFER, EXPORT_NETEX, EXPORT_CONCERTO, BUILD_MAP_MATCHING, EXPORT_TO_CONSUMER}
