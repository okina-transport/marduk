...
public class Parameters {
    ...
    public static String getGtfsExportParameters(Provider provider, String exportName, String user, boolean keepOriginalId, List<Long> linesIds, Date startDate, Date endDate, String exportedFilename, IdParameters idParams,
        ...
        try {
            ...
            GtfsExportParameters.GtfsExport gtfsExport = new GtfsExportParameters.GtfsExport(exportName == null ? "offre" : exportName,
                    ...
                    commercialPointExport, attributionsExportModes, googleMapsCompatibility, useExtendedGtfsRouteTypes, agencyParams, exportedReferentials, exportConfigurationId, exportAllLines, serviceJourneyTripObjectName);
    ...
    public static String getGtfsExportParameters(Provider provider, String user, boolean keepOriginalId, String exportedFilename, Boolean commercialPointExport, AttributionsExportModes attributionsExportModes, Boolean googleMapsCompatibility, Boolean useExtendedGtfsRouteTypes, Long exportConfigurationId, boolean exportAllLines) {
        return getGtfsExportParameters(provider, null, user, keepOriginalId, null, null, null, exportedFilename, new IdParameters(), false, commercialPointExport, attributionsExportModes, googleMapsCompatibility, useExtendedGtfsRouteTypes, new AgencyParameters(), null, exportConfigurationId, exportAllLines, false);
    }


    public static String getNetexExportProvider(Provider provider, boolean exportStops, String user, String exportedFilename, String exportedReferentials, Long exportConfigurationId, String exportGeneratedMissingQuays, String exportExternalIds) {
        try {
            ChouetteInfo chouetteInfo = provider.chouetteInfo;
