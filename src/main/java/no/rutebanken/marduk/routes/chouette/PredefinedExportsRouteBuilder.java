    ...
    public void configure() throws Exception {
        ...
        from("jms:queue:predefinedExport?transacted=true").streamCache(Boolean.TRUE)
                ...
                .process(e -> {
                    ...
                    e.getMessage().getHeaders().put(SERVICE_JOURNEY_IN_TRIP_OBJECT_NAME, export.isServiceJourneyTripObjectName());
                    e.getMessage().getHeaders().put(FLEX_INCLUDED_HEADER,export.isIncludeFlex());
