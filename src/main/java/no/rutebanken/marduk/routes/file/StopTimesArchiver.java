...
@Component
public class StopTimesArchiver {

    private static Logger logger = LoggerFactory.getLogger(StopTimesArchiver.class);
    ...
    public void archiveStopTimes(File inputFile, String organisation)  {
        ...
        try{
            ...
            File archivedFile = new File(getDestinationDir(organisation), getDestinationFileName());
            archivedFile.mkdirs();
     ...
     */
    private String getDestinationDir(String organisation){
        return chouetteStoragePath + "/mobiiti_technique/stop_times/" + organisation.toUpperCase();
    }
    ...
    private String getDestinationFileName(){
        ...
        return "stop_times_" + dateStr + ".txt";
    }
}
