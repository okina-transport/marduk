 ...
 */
@Component
public class TiamatExportPointsOfInterestBuilder extends AbstractChouetteRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("activemq:queue:TiamatPointOfInterestExport").streamCaching()
                ...
                .process(e -> {
                    ...
                    log.info("Lancement export POI - Fichier : " + exportJob.getFileName() + " - Espace de données : " + getProviderRepository().getProvider(e.getIn().getHeader(PROVIDER_ID, Long.class)).chouetteInfo.referential);
                })

                .setHeader(Constants.CHOUETTE_JOB_STATUS_ROUTING_DESTINATION, constant(TIAMAT_EXPORT_POI_ROUTING_DESTINATION))
        ...
        from(TIAMAT_EXPORT_POI_ROUTING_DESTINATION).streamCaching()
                ...
                .choice()
                    ...
                    .log(LoggingLevel.INFO, "Sending of the netex file stops generated by mobiiti_technique => " + MERGED_NETEX_POI_ROOT_DIR + "/CurrentAndFuture_latest.zip")
                    .setHeader(FILE_HANDLE, simple(MERGED_NETEX_POI_ROOT_DIR + "/CurrentAndFuture_latest.zip"))
                    .to("direct:uploadBlob")
                .end()
                .routeId("tiamat-points-of-interest-export-result-job");
    }
