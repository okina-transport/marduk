...
public class Constants {
    ...
    public static final String FLEX_INCLUDED_HEADER = "flexIncluded";
    ...
    public static final String EXPORT_EXTERNAL_IDS = "exportExternalIds";
    public static final String HAS_POST_PROCESS = "hasPostProcess";
